...
savour.component.TemplateGallery = function(options, element) {
  ...
  this.thumbnail_slick = null;
  this.gallery_slick = null;

  this.gallery_item_container_element = this.element.find('#page-template-banner-gallery-item-container');
  this.thumbnail_container_element = this.element.find('#page-template-banner-thumbnail-item-container');
...
savour.component.TemplateGallery.prototype.init = function() {
  this.create_slick();
};

savour.component.TemplateGallery.prototype.create_slick = function() {
  ...
  this.gallery_slick = this.gallery_item_container_element.slick({
      dots: false,
      infinite: false,
      speed: 500,
      fade: true,
  ...
  this.gallery_slick.on('afterChange', function(event, slick, current_slide){
    ...
    this.update_gallery_text(current_slide);
  ...
  this.thumbnail_slick = this.thumbnail_container_element.slick({
    dots: false,
    infinite: false,
    speed: 500,
    fade: false,
 ...
 */
savour.component.TemplateGallery.prototype.update_gallery_text = function(number_param) {
  console.log('update_gallery_text: ' + number_param);
