...
<?php if($is_debug): ?>
  ...
  <!-- <link href="assets/libs/video.js/dist/video-js.css" rel="stylesheet" type="text/css"> -->
  <script src="assets/libs/video.js/dist/ie8/videojs-ie8.min.js"></script>
  ...
  <script type="text/javascript">
    goog.require('savour.page.Article');
  </script>
  <script type="text/javascript">
    page = new savour.page.Article({});
  </script>
...
<?php else: ?>
  ...
  <script type="text/javascript">
    ...
    var PAGE_JS             = "assets/js/page-article.min.js";
